<template>
    <div id="create-task-form">
        ...
        <form class="vue-form" @submit.prevent="submit">
            ...
            <fieldset>
            <legend>Create New Task - {{username}}</legend>
            <div>
            ...
            <div>
                <input type="submit" value="Create" @click='submitForm()'>
            </div>
            </fieldset>
        </form>
...
export default {
  ...
  data() {
    return {
      ...
      message: {
        text: `Start new project for shits and giggles,\n...`,
        maxlength: 255
      },
      submitted: false
    };
